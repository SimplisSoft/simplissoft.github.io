...
(function (g, i, j, b) {
        ...
        g(m.element)
          ...
          .append(
            '<div class="button digg"><a class="DiggThisButton ' +
              ...
              encodeURIComponent(n.url !== "" ? n.url : m.options.url) +
              '"></a></div>'
          );
        var o = 0;
      ...
      googlePlus: function (m) {
        i.open(
          "https://plus.google.com/share?hl=" +
            ...
            "&url=" +
            encodeURIComponent(
              m.buttons.googlePlus.url !== "" ? m.buttons.googlePlus.url : m.url
            ),
          "",
      ...
      facebook: function (m) {
        i.open(
          "http://www.facebook.com/sharer/sharer.php?u=" +
            encodeURIComponent(
              m.buttons.facebook.url !== "" ? m.buttons.facebook.url : m.url
            ) +
            "&t=" +
            m.text +
            "",
      ...
      twitter: function (m) {
        i.open(
          "https://twitter.com/intent/tweet?text=" +
            ...
            "&url=" +
            encodeURIComponent(
              m.buttons.twitter.url !== "" ? m.buttons.twitter.url : m.url
            ) +
            (m.buttons.twitter.via !== ""
              ? "&via=" + m.buttons.twitter.via
              : ""),
          "",
      ...
      digg: function (m) {
        i.open(
          "http://digg.com/tools/diggthis/submit?url=" +
            encodeURIComponent(
              m.buttons.digg.url !== "" ? m.buttons.digg.url : m.url
            ) +
            "&title=" +
            m.text +
      ...
      delicious: function (m) {
        i.open(
          "http://www.delicious.com/save?v=5&noui&jump=close&url=" +
            encodeURIComponent(
              m.buttons.delicious.url !== "" ? m.buttons.delicious.url : m.url
            ) +
            "&title=" +
            m.text,
          "delicious",
      ...
      pinterest: function (m) {
        i.open(
          "http://pinterest.com/pin/create/button/?url=" +
            encodeURIComponent(
              m.buttons.pinterest.url !== "" ? m.buttons.pinterest.url : m.url
            ) +
            "&media=" +
  ...
  k.prototype.getSocialJson = function (o) {
    ...
    if (
      this.options.buttons[o].urlCount === true &&
                ...
                r
                  ? "string" != typeof r
                    ? r.length &&
                      ...
                      : ((this._siblings[n] = K(r, this, !1)),
                        1 === l &&
                          this._siblings[n].length > 1 &&
                          J(r, this, null, 1, this._siblings[n]))
                    : ((r = a[n--] = I.selector(r)),
      ...
      [].slice
        ...
        .forEach(function (element) {
          element.setAttribute(
            "xlink:href",
            baseUrl.replace("#", "") + element.getAttribute("xlink:href")
          );
        });
    },
    false
...
!(function (e, n, t) {
  ...
  var e = function () {
    ...
    s = function () {
      ...
      return (
        (n = Math.round(100 * n) / 100), { zoom: n, devicePxPerCssPx: n * e() }
      );
    },
    ...
    if (elementPosition.indexOf("right") != -1) {
      ...
      if (elementPosition.indexOf("left") != -1) {
        ...
        if (elementPosition.indexOf("center") != -1) {
          offsetX =
            offsetX - $element.outerWidth() / 2 + $this.outerWidth() / 2;
